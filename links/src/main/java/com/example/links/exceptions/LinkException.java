package com.example.links.exceptions;
...
public class LinkException extends Exception{
    ...
    public static final String PASSWORD_NECESARIA = "PASSWORD_NECESARIA";
    public static final String PASSWORD_NECESARIA_MSG = "La contraseña es obligatoria";
